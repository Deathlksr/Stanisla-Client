...
public class MainMenuScreen extends GuiScreen {
    ...
    public void initGui() {
        ...
        buttonList.add(new Button(1,"Multi Player", sc.getScaledWidth() / 2f - 75,sc.getScaledHeight() / 2f - 10 + 30, 150, 20));
        buttonList.add(new Button(2,"Minecraft Settings", sc.getScaledWidth() / 2f - 75,sc.getScaledHeight() / 2f - 10 + 30 + 30, 150, 20));
    }
